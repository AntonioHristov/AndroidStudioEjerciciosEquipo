...
public class HuTrueno extends AHechizo {
    public HuTrueno() {
        super("Trueno", "Trueno uso. Quita 1500 de vida a un jugador", R.drawable.hu_trueno, EAccionHechizo.USAR);
    }

    public HuTrueno(HuDisparo copia) {
        super(copia);
    }
