...
/*
    ...
    public static boolean comprobarConexionCliente() {
        ...
        Callable<Boolean> task = new Callable<Boolean>() {
            ...
            public Boolean call() {
                try {
                    ...
                    recibir.close();
                    socket.close();
                    System.out.println("Conexion exitosa en teoria");
                    return true;
                } catch (Exception e) {
                    e.printStackTrace();
    ...
    public static boolean registrarApodoEnServidor(String apodo){
        ExecutorService executor = Executors.newSingleThreadExecutor();
        Callable<Boolean> task = new Callable<Boolean>() {
            @Override
            public Boolean call() {
                try {
                    ...
                    enviar.println(ECodigosTCP.REGISTRARSE.name());
