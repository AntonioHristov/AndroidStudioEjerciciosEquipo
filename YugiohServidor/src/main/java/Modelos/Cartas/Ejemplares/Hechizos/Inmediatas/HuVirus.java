...
public class HuVirus extends AHechizo {
    public HuVirus() {
        super("Virus", "Virus uso. Hace 2000 daño a un monstruo", R.drawable.hu_virus, EAccionHechizo.USAR);
    }

    public HuVirus(HuDisparo copia) {
        super(copia);
    }
